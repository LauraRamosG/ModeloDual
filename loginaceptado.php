...
<html lang="en">
    <head>
        ...
        <title>Iniciar sesión - Alumno aceptado</title>
  ...
  <style>
   body {
    ...
    <body class="grid-container">
            ...
            <div class="main">
                <form class="sesion" action="validaraceptado.php" method="post">
                    <h4>Iniciar sesión </h4>
                    <input class="controls" type="text" name="matricula" placeholder="Matricula">
                    <input class="controls" type="password" name="matricula" placeholder="Contraseña">
