...
<body class="grid-container">
  ...
  <main class="main">
   ...
   <br>
<a href="mentorsistemas.php" target="_blank" style="text-decoration:none"> <button  class="custom-btn btn-3"><span>Generar PDF</span><span>Ing. Sistemas</span></button><a>

            <a href="mentorambiental.php" target="_blank" style="text-decoration:none"><button class="custom-btn btn-3"><span>Generar PDF</span><span>Ing. Ambiental</span></button> </a>

            <a href="mentorinformatica.php" target="_blank" style="text-decoration:none"><button class="custom-btn btn-3"><span>Generar PDF</span><span>Ing. Informática</span></button></a>

            <a href="mentoradministracion.php" target="_blank" style="text-decoration:none">
           <button class="custom-btn btn-3"><span>Generar PDF</span><span>Lic. Administración</span></button></a>

            <a href="mentorarquitectura.php" target="_blank" style="text-decoration:none"><button class="custom-btn btn-3"><span>Generar PDF</span><span>Lic. Arquitectura</span></button></a>

            <a href="mentorbiomedica.php" target="_blank" style="text-decoration:none"> <button class="custom-btn btn-3"><span>Generar PDF</span><span>Ing. Biomédica</span></button></a>

            <a href="mentorelectronica.php" target="_blank" style="text-decoration:none">
            <button class="custom-btn btn-3" ><span>Generar PDF</span><span>Ing. Electrónica</span></button></a>
<?php
  if (isset($_POST['buscar'])) {
    //Recogemos las claves enviadas
    $carrera = $_POST["carrera"];
    $query = "SELECT * FROM datostutores WHERE carrera LIKE '%".$carrera."%'";
    ...
    if ($count_results > 0) {
        while ($mostrar = mysqlI_fetch_array($query_searched)) {
            ...
            <tr>
              ...
              <td><center><?php echo $mostrar['id_trabajador'] ?></center></td>
              ...
              <td><center><?php echo $mostrar['perfil'] ?></center></td>
            </tr>
          <?php 
        }
        ?>
