          ...
          if(!empty($_FILES['file']['name'])){
            ...
            move_uploaded_file($tname, $uploads_dir.'/'.$pname);
                ...
                try {
                    ...
                    $subject = utf8_decode('Carta de aceptación al Modelo Dual');
                    $body = utf8_decode('Buen día, un placer saludarl@.<br><br>Me comunico con usted para hacer la entrega del documento oficial que avala la aceptación a la incorporación al Modelo de Educación Dual.<br> Sin más por el momento, reciba un cordial saludo
<br><br><p style="color:darkgreen";>Este mensaje fue enviado automáticamente, no responder a este correo.</p>');
                    ...
                    if(!$mail->send()){
                        ...
                        window.location.assign("generaryenviarcarta.php");
                        </script>';
                        <?php
                    }
                } catch (Exception $e) {       
            ...
            window.location.assign("generayenviarcarta.php");
            </script>';
            <?php
        }
        }
...
<html>
  <head>
    ...
    <title>Generar y enviar carta</title>
...
<main class="main">
  ...
  <form class="registro" method="post" target="_blank" action="ex.php">
    <h4>Generar carta</h4>
    ...
    ?>
     ...
     <input class="controls" name='proyecto' placeholder="Ingrese el proyecto asignado">
