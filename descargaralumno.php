...
<html lang="en">
   ...
   body {
    ...
    <body class="grid-container">
            ...
            <div class="main">
              <h3>Descargar documentos:<br><br></h3>
              
                <ul class="botones">
                    <li><a href="manual/evaluacion_psicometrica.docx" download="Evaluación Psicométrica.docx">Descargar evaluación psicométrica</a></li>
                    <li><a href="manual/carta_compromiso.docx" download="Carta Compromiso.docx">Descargar carta compromiso</a></li>
                </ul>
            <div class="gallery">
          ...
          <img src="img/compromiso.png" alt="">
              ...
              <h5><br>*Ambos documentos se deben de llenar/imprimir en hoja membretada oficial del Tecnológico.</h5>
