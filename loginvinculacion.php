...
<html lang="en">
   ...
   body {
    ...
    <body class="grid-container">
            ...
            <div class="main">
                <form class="sesion" action="validarvinculacion.php" method="post">
                    <h4>Inicie sesión en su cuenta</h4>
                    <input class="controls" type="text" name="id" placeholder="ID de empleado">
                    ...
                    <h5><a href="recuperarvinculacion.php">Olvidé la contraseña</a></h5>
                </form>
            </div>
            <div class="footer">
            </div>     
